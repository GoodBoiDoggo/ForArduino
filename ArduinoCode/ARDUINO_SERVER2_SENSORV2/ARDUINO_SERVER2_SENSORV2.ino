...
String boi;
void loop() {
  emon1.calcVI(20, 1500);
  if(total<999999){
    total=total + emon1.realPower;
  }
  ...
  if (Serial1.available()) // check if the esp is sending a message
  {
    ...
    if (Serial1.find("+IPD,"))
    {
      ...
      //      }
      if (Serial1.find("/getsensordata")) {

        Serial.println("READING" + (String)emon1.realPower);
        emon1.serialprint();
      ...
      sendSerial1Cmdln(cmdCIPCLOSE, 750);
    }
